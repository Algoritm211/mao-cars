  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <button className="btn justify-self-end md:mt-6 md:mr-2" onClick={onToggleEditProfileModal}>
          Edit profile
        </button>
      </div>
      ...
      <div className="px-2 mt-2">
        ...
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur consequatur, corporis
          debitis deserunt dolor eius, hic, in itaque iure laudantium obcaecati porro quae quasi
          quidem quisquam suscipit voluptatum! Nobis, quia?
        </p>
      </div>
